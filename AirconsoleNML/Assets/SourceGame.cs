...
public class SourceGame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        print("Amount of sourceGame questions left: " + realFakeList.Count);
        gameLogic.GetComponent<GamesData>().setSourceGameData(realFakeList);
    ...
    private List<RealFakeData> getData()
    {
        ...
        List<RealFakeData> dataList = GameObject.FindGameObjectWithTag("GameLogic").GetComponent<GamesData>().getSourceGameData();
