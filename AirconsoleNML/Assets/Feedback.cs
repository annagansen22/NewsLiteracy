...
public class Feedback : MonoBehaviour
{
    ...
    {
        string curName = GameObject.FindGameObjectWithTag("GameLogic").GetComponent<GameStats>().getTeam(device_id).getTeamName();
        GameObject.FindGameObjectWithTag("GameLogic").GetComponent<AIComponent>().displayTeamName(device_id, curName);
