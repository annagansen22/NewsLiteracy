...
public class EntryScreen : MonoBehaviour
{
    ...
    private void OnConnect(int device_id)
    {
        ...
        {
            GameObject.FindGameObjectWithTag("GameLogic").GetComponent<AIComponent>().displayTeamName(device_id, GameObject.FindGameObjectWithTag("GameLogic").GetComponent<GameStats>().getTeam(device_id).getTeamName());
    ...
    public void startGame()
    {
        ...
        int t = 30;
        string time;
        if (FindObjectOfType<TMP_InputField>() != null)
        {
